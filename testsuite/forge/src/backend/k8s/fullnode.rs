...
use aptos_config::{
    config::{
        merge_node_config, BaseConfig, DiscoveryMethod, ExecutionConfig, NetworkConfig, NodeConfig,
...
pub fn get_default_pfn_node_config() -> NodeConfig {
    ...
    NodeConfig {
        ...
        // API defaults to listening on "127.0.0.1:8080"
        ..NodeConfig::default()
    }
}
